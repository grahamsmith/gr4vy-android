...
class Config(private val metaData: Bundle) : IConfig {
    ...
    override val buyerId: String get() = metaData.getString("gr4vy-buyerId", "")
    ...
    init {
        ...
        require(buyerId.isNotBlank()) { "Buyer ID must be set - add <meta-data android:name=\"gr4vy-buyerId\" android:value=\"BUYER-ID\" /> to the manifest" }
    }
